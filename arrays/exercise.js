...
const remove = (list, i) => { list.splice(i, 1) }

/*Task 2

Write a function reversed(list) that takes an array of 
strings, and returns a single string which consists of all the 
...
const reversed = (list) => list.reverse().join()
...
const calculatePercentages = (scores, totalPossibleScore) => scores.map(score => score * (100 / totalPossibleScore ))
...
function ExamResultSet(examResultList) { 
    this.result = examResultList
  }
...
Create a AddableExamResultSet constructor that takes no arguments, 
and inherits getHighest and getLowest and getAverage from 
ExamResultSet.

It should also have the following function:

add() that takes a number as the argument, and adds this number 
...
AddableExamResultSet.prototype = 
    Object.create(ExamResultSet.prototype)
